...
public class IronShulkerBoxRecipeBuilder {
   ...
   * Adds a key to the recipe pattern.
   */
  public IronShulkerBoxRecipeBuilder key(Character symbol, Ingredient ingredientIn) {
   ...
   */
  public IronShulkerBoxRecipeBuilder patternLine(String patternIn) {
  ...
  public IronShulkerBoxRecipeBuilder setGroup(String groupIn) {
    this.group = groupIn;
    return this;
  }
